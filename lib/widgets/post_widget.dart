      ...
      builder: (context, postSnapshot) {
        ...
        return StreamBuilder<DocumentSnapshot>(
          ...
          builder: (context, userSnapshot) {
            ...
            // Handle tags properly based on their type in Firestore
            List<String> tagsList = [];
            var tags = postData['tags'];

            if (tags is String) {
              // If tags is stored as a comma-separated string
              tagsList = tags.split(',');
            } else if (tags is List) {
              // If tags is stored as a List in Firestore
              tagsList = List<String>.from(tags.map((tag) => tag.toString()));
            }
            ...
            return Column(
              ...
              children: [
                      ...
                      onTap: () {
                        final postModel = PostModel(
                          ...
                          name: userdata['fullname'] ?? 'Unknown',
                           ...
                           Navigator.push(context,MaterialPageRoute(builder: (context) => EditPostScreen(post: postModel, postId: widget.postId!),));
                ...
                Wrap(
                  children: tagsList.map((tag) => tagsChip(text: tag.trim())).toList(),
                ),
